...
export default function ThreeBHKVillasBodupalPage() {
  return (
    <main className="min-h-screen" style={{ background: "var(--bg)" }}>
      <Breadcrumbs items={[{ label: "3 BHK Villas in Boduppal", href: "/3bhk-villas-boduppal" }]} />
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm" style={{ borderCollapse: "collapse" }}>
              <tbody style={{ color: "var(--ink-2)" }}>
                ...
                <tr>
                  <td className="p-3 font-semibold border" style={{ borderColor: "var(--edge)", color: "var(--ink)" }}>BHK Configuration</td>
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}><strong>3 BHK + Pooja Room</strong> (3 bedrooms, all with attached bathrooms)</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold border" style={{ borderColor: "var(--edge)", color: "var(--ink)" }}>Built-up Area</td>
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>2,200 to 2,500 Sq. Ft (varies by villa type)</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold border" style={{ borderColor: "var(--edge)", color: "var(--ink)" }}>Floor Distribution</td>
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>G+1+Penthouse (Ground: ~1,100 SFT | First: ~700 SFT | Penthouse: ~400 SFT)</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="p-3 font-semibold border" style={{ borderColor: "var(--edge)", color: "var(--ink)" }}>Pooja Room</td>
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>Dedicated Pooja Room on ground floor (~50 SFT)</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold border" style={{ borderColor: "var(--edge)", color: "var(--ink)" }}>Parking</td>
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>2-car covered parking per villa</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>8 min to Uppal Metro (Blue Line)</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold border" style={{ borderColor: "var(--edge)", color: "var(--ink)" }}>IT Hub Distance</td>
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>HITEC City: 12 km (20 min), Gachibowli: 15 km (25 min)</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold border" style={{ borderColor: "var(--edge)", color: "var(--ink)" }}>Design Customization</td>
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>Full customization: elevation, floor plan, finishes</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold border" style={{ borderColor: "var(--edge)", color: "var(--ink)" }}>Schools Nearby</td>
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>DPS (4 km), Oakridge International (12 km)</td>
                </tr>
                <tr>
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p style={{ color: "var(--ink-2)" }} className="text-base leading-relaxed mb-8">
            24,000 SFT recreation zone for only 33 families = 750 SFT per family. Most projects offer 200 SFT per family. 3-4x more space for your family to enjoy.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6" style={{ color: "var(--ink-2)" }}>
            ...
            <div>
              ...
              <p className="text-sm">Estimated ₹4,000-5,000/month for 3 BHK villa (covers security, common area maintenance, landscaping). Much lower than apartments (₹8-10K) because only 33 families share costs.</p>
            </div>
