      ...
      <section className="py-12 px-6" style={{ background: "var(--bg)", borderTop: "1px solid var(--edge)", borderBottom: "1px solid var(--edge)" }}>
        <div className="max-w-4xl mx-auto">
          <h2 style={{ color: "var(--ink)" }} className="font-heading text-2xl sm:text-3xl font-light mb-6 text-center">
            Quick Facts — The Pavillion Villas, Boduppal
          </h2>
            ...
            <table className="w-full text-sm" style={{ borderCollapse: "collapse" }}>
              <tbody style={{ color: "var(--ink-2)" }}>
                ...
                <tr>
                  ...
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>150 to 228 Sq. Yds (varied orientations)</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>8 min to Uppal Metro (Blue Line). Ameerpet: 25 min, Secunderabad: 30 min</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold border" style={{ borderColor: "var(--edge)", color: "var(--ink)" }}>IT Hub Distance</td>
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>HITEC City: 12 km (20 min), Gachibowli: 15 km (25 min), Uppal IT Park: 8 km</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold border" style={{ borderColor: "var(--edge)", color: "var(--ink)" }}>Airport Distance</td>
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>Rajiv Gandhi International Airport: 25 km (35 min via ORR)</td>
                </tr>
                <tr>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6" style={{ color: "var(--ink-2)" }}>
            ...
            <div>
              ...
              <p className="text-sm">24,000 SFT Bommaku Recreation Zone with swimming pool, infinity pool, gym, yoga room, sauna, sports courts (football, pickleball, cricket), restaurant, cafe, kids play area, landscaped gardens, 24x7 security.</p>
            </div>
