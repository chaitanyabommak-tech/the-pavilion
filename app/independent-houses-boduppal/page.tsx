...
export default function IndependentHousesBodupalPage() {
  return (
    <main className="min-h-screen" style={{ background: "var(--bg)" }}>
      <Breadcrumbs items={[{ label: "Independent Houses in Boduppal", href: "/independent-houses-boduppal" }]} />
            ...
            <table className="w-full text-sm" style={{ borderCollapse: "collapse" }}>
              <tbody style={{ color: "var(--ink-2)" }}>
                ...
                <tr>
                  ...
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}><strong>Independent Houses</strong> (standalone, no shared walls, four-side open)</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>150 to 228 Sq. Yds (individual plots, varied orientations)</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold border" style={{ borderColor: "var(--edge)", color: "var(--ink)" }}>Built-up Area</td>
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>2,200 to 2,500 Sq. Ft</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}><strong>ZERO</strong> — TRUE independent houses (not row houses)</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold border" style={{ borderColor: "var(--edge)", color: "var(--ink)" }}>Privacy Level</td>
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>Maximum — four-side open plots, individual compound walls</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold border" style={{ borderColor: "var(--edge)", color: "var(--ink)" }}>Design Freedom</td>
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>Full customization: elevation, floor plan, finishes (in-house architects)</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold border" style={{ borderColor: "var(--edge)", color: "var(--ink)" }}>Recreation Zone</td>
                  <td className="p-3 border" style={{ borderColor: "var(--edge)" }}>24,000 Sq. Ft (750 Sq. Ft per house — 7-8X industry average)</td>
                </tr>
                <tr>
