...
export default async function GalleryDB() {
  ...
  const fallbackImages = [
    { src: "/images/gallery/pavilion-grand-entrance-main.jpg", alt: "Grand Entrance of The Pavillion villa community in Boduppal", caption: "Grand Entrance" },
    { src: "/images/pavilion/recreation-zone/aerial-view-01.jpg", alt: "Recreation Zone at The Pavillion villa community in Boduppal", caption: "Recreation Zone" },
    { src: "/images/pavilion/entrance/NEW-CLEAN-ENTRANCE.jpg", alt: "Convenience Store at The Pavillion by Bommaku Group", caption: "Convenience Store" },
    { src: "/images/pavilion/exteriors/villa-street-view-02.jpg", alt: "The Pavillion villa community with contemporary design language", caption: "Villa Community" },
