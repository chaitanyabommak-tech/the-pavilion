...
const images = [
  { src: "/images/pavilion/entrance/grand-entrance-clean.jpg?v=2",  alt: "The Pavilion villa community grand entrance gate by Bommaku Group", caption: "Grand Entrance" },
