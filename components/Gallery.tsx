...
const images = [
  { src: "/images/pavilion/entrance/grand-entrance-final.jpg?v=3",  alt: "The Pavilion villa community grand entrance gate by Bommaku Group", caption: "Grand Entrance" },
